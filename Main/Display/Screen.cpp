...
// Matches Main/vga/vga.cc's RAM_CODE section name -- init() copies whatever
// lands in it (driver code and this) into ITCM before any of it can run.
__attribute__((section(".vga_ramcode")))
