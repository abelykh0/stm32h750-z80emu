...
/*
 * Common shorthand for a pixel, which we store in an 8-bit byte -- the exact
 * byte DMA'd to GPIOB's high byte (see vgaConfig.h's vga_make_pixel()).
 */
 ...
 * contained in the given Timing struct.
 *
