...
#define KEY_KP8      0x75
#define KEY_KP9      0x7D
#define KEY_KEYPAD_DECIMAL_SEPARATOR_DELETE	0x71
#define KEY_KEYPAD_PLUS        0x79
#define KEY_KEYPAD_MINUS       0x7B
#define KEY_KEYPAD_ASTERIKS    0x7C
#define KEY_0_CPARENTHESIS     0X45
#define KEY_1_EXCLAMATION_MARK 0X16
#define KEY_2_AT               0X1E
#define KEY_3_NUMBER_SIGN      0X26
#define KEY_4_DOLLAR           0X25
#define KEY_5_PERCENT          0X2E
#define KEY_6_CARET            0X36
#define KEY_7_AMPERSAND        0X3D
#define KEY_8_ASTERISK         0X3E
#define KEY_9_OPARENTHESIS     0X46
#define KEY_APOS               0X52
#define KEY_COMMA_AND_LESS     0X41
#define KEY_MINUS_UNDERSCORE   0X4E
#define KEY_DOT_GREATER        0X49
#define KEY_SLASH_QUESTION     0X4A
